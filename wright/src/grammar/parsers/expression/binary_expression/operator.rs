...
impl BinaryOp {
        ...
        I: WrightInput,
    {
        ...
        move |input| {
            trace_result(
                trace,
                value(result, alt((tag(short), tag(long))))(input.trace_start_clone(trace)),
            )
        }
    }
    ...
    pub fn parse_logical_and<I: WrightInput>(input: I) -> IResult<I, BinaryOp> {
        ...
        trace_result(
            trace,
            Self::short_or_long("&&", BinaryOp::LOGICAL_AND, BinaryOp::LogicalAnd)(
    ...
    pub fn parse_logical_or<I: WrightInput>(input: I) -> IResult<I, BinaryOp> {
        ...
        trace_result(
            trace,
            Self::short_or_long("||", BinaryOp::LOGICAL_OR, BinaryOp::LogicalOr)(
                input.trace_start_clone(trace),
            ),
        )
    }
    ...
    pub fn parse_or<I: WrightInput>(input: I) -> IResult<I, BinaryOp> {
        ...
        trace_result(
            trace,
            value(BinaryOp::Or, ch('|'))(input.trace_start_clone(trace)),
        )
    }
    ...
    pub fn parse_xor<I: WrightInput>(input: I) -> IResult<I, BinaryOp> {
        ...
        trace_result(
            trace,
            value(BinaryOp::Xor, ch('^'))(input.trace_start_clone(trace)),
        )
    }
    ...
    pub fn parse_and<I: WrightInput>(input: I) -> IResult<I, BinaryOp> {
        ...
        trace_result(
            trace,
            value(BinaryOp::And, ch('&'))(input.trace_start_clone(trace)),
        )
    }
    ...
    pub fn parse_arithmetic_operator1<I: WrightInput>(input: I) -> IResult<I, BinaryOp> {
        ...
        trace_result(
            trace,
            alt((value(BinaryOp::Add, ch('+')), value(BinaryOp::Sub, ch('-'))))(
                input.trace_start_clone(trace),
            ),
        )
    }
